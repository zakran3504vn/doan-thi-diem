...
<body>
    ...
    <main class="body-content">
        ...
        <section class="mobile slider show-on-scroll home-page" data-sizes="50vw" id="mb_slider_cover">
            <a href="xuan-olympia-2026-gieo-mam-hanh-phuc-mo-loi-tuong-lai.html" class="slider-item " title="">
                <img src="storage/mobile-trai-nghiem-xuan-2026-01.jpg" alt="">
                <div class="slider-title-box" style="opacity: 0">
            ...
            <a href="hoc-bong-griffin-2026-khac-biet-ban-sac-dan-loi-tuong-lai.html" class="slider-item " title="">
                <img src="storage/website-mobile-gia-han.png" alt="">
                <div class="slider-title-box" style="opacity: 0">
            ...
            <a href="bloom-beyond-vuon-minh-bung-no" class="slider-item " title="">
                <img src="storage/banner-web-375x490.png" alt="">
                <div class="slider-title-box" style="opacity: 0">
            ...
            <a href="wasc-chinh-thuc-cong-nhan-olympia-dat-chuan-kiem-dinh-toan-dien.html" class="slider-item "
                title="">
                <img src="storage/mobile-wasc.jpg" alt="">
                <div class="slider-title-box" style="opacity: 0">
            ...
            <a href="olympia-chinh-thuc-tro-thanh-truong-hoc-ib-ib-world-school.html" class="slider-item " title="">
                <img src="storage/banner-web-ib-mobile-chung-nhan-03-1.jpg" alt="">
                <div class="slider-title-box" style="opacity: 0">
        ...
        <section class="pc slider show-on-scroll home-page" data-sizes="50vw" id="pc_slider_cover">
            <div class="slider-item ">
                <a href="xuan-olympia-2026-gieo-mam-hanh-phuc-mo-loi-tuong-lai.html" title="">
            ...
            <div class="slider-item ">
                <a href="bloom-beyond-vuon-minh-bung-no" title="">
            ...
            <div class="slider-item ">
                <a href="wasc-chinh-thuc-cong-nhan-olympia-dat-chuan-kiem-dinh-toan-dien.html" title="">
                    <img src="storage/web-wasc-1920x1080.jpg" alt="">
                </a>
                <div class="slider-title-box">
            ...
            <div class="slider-item ">
                <a href="olympia-chinh-thuc-tro-thanh-truong-hoc-ib-ib-world-school.html" title="">
                    <img src="storage/banner-web-ib-chung-nhan-02-1-1920x1080.jpg" alt="">
                </a>
                <div class="slider-title-box">
        ...
        <div class="container text-center olympia-number-box home-index">
            ...
            <div class="olympia-number-right pc-device show-on-scroll">
